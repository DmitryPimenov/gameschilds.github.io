$(function(){
	...
	var conditions = {
		"clear-day":{
			wi:"wi wi-day-sunny",
			url:"https://i.ibb.co/sCHj1vz/clear-sky-min.jpg?dl=0&raw=1"
		}, 
		"clear-night":{
			wi:"wi wi-night-clear",
			url:"https://i.ibb.co/2N3Zcqy/stars-transparent-background.png?dl=0&raw=1"
		}, 
		"rain":{
			wi:"wi wi-rain",
			url:"https://i.ibb.co/4KDX8Bh/air-2241577-960-720-min.jpg?dl=0&raw=1"
		}, 
		"snow":{
			wi:"wi wi-snow",
			url:"https://i.ibb.co/4KDX8Bh/air-2241577-960-720-min.jpg?dl=0&raw=1"
	...
	function getCurrentWeather(pos) {
		$.getJSON("https://api.darksky.net/forecast/75a4c6b840bd5cd4c5d545326a12072c/"+pos.latitude+","+pos.longitude+"?units=si&callback=?", function(data){
			...
			$.getJSON("https://maps.googleapis.com/maps/api/geocode/json?key=AIzaSyDrd5FUzXQvUXYUrlzp3QiRLmR4utGsz1g&latlng="+ pos.latitude+","+pos.longitude, function(gglData){
				place = gglData.results[1].address_components[2].long_name;
				$(".city").text(place);
			});
			$(".temp").text(temp);
